...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _cms_dialog__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../cms.dialog */ "./private/js/cms.dialog.js");
...
*/
        ...
        editPlugin: function (element, editor) {
			...
			new _cms_dialog__WEBPACK_IMPORTED_MODULE_0__["default"](editor.element.$, saveSuccess => {
				if (saveSuccess) {
        ...
        addPlugin: function (item, panel, editor) {
			...
			new _cms_dialog__WEBPACK_IMPORTED_MODULE_0__["default"](editor.element.$, data => {
				if (data.plugin_id) {
...
/* harmony export */   CmsForm: () => (/* binding */ CmsForm),
/* harmony export */   "default": () => (/* binding */ CmsDialog),
/* harmony export */   formToHtml: () => (/* binding */ formToHtml),
/* harmony export */   populateForm: () => (/* binding */ populateForm)
/* harmony export */ });
/* harmony import */ var _css_cms_dialog_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../css/cms.dialog.css */ "./private/css/cms.dialog.css");
/* eslint-env es6 */
/* jshint esversion: 6 */
