...
const TiptapToolbar = {
    ...
    LinkPlugin: {
        action: (editor) => editor.chain().addCmsPlugin('LinkPlugin').run(),
        enabled: (editor) => editor.can().addCmsPlugin('LinkPlugin', true),
        active: (editor) => editor.isActive('cmsPlugin', {type: 'LinkPlugin'}),
        type: 'mark',
    },
    ImagePlugin: {
        action: (editor) => editor.chain().addCmsPlugin('ImagePlugin').run(),
        enabled: (editor) => editor.can().addCmsPlugin('ImagePlugin', true),
        active: (editor) => editor.isActive('cmsPlugin', {type: 'ImagePlugin'}),
        type: 'mark',
    },
    Unlink: {
